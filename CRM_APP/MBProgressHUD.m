...
+ (MB_INSTANCETYPE)showHUDAddedTo:(UIView *)view animated:(BOOL)animated {
    ...
    hud.labelText=@"Please wait while authenticate";
	[view addSubview:hud];
	[hud show:animated];
	return MB_AUTORELEASE(hud);
}
+ (MB_INSTANCETYPE)showHUDAddedLoading:(UIView *)view animated:(BOOL)animated {
    MBProgressHUD *hud = [[self alloc] initWithView:view];
    hud.removeFromSuperViewOnHide = YES;
...
+ (MB_INSTANCETYPE)showHUDAddedToDearler:(UIView *)view animated:(BOOL)animated {
    MBProgressHUD *hud = [[self alloc] initWithView:view];
    hud.removeFromSuperViewOnHide = YES;
    hud.labelText=@"Fetching Dealers";
    [view addSubview:hud];
    [hud show:animated];
    return MB_AUTORELEASE(hud);
}

+ (MB_INSTANCETYPE)showHUDAddedToLoad:(UIView *)view animated:(BOOL)animated {
    MBProgressHUD *hud = [[self alloc] initWithView:view];
    hud.removeFromSuperViewOnHide = YES;
    hud.labelText=@"Journey Started";
    [view addSubview:hud];
    [hud show:animated];
    return MB_AUTORELEASE(hud);
}
+ (MB_INSTANCETYPE)showHUDAddedToCountry:(UIView *)view animated:(BOOL)animated {
    MBProgressHUD *hud = [[self alloc] initWithView:view];
    hud.removeFromSuperViewOnHide = YES;
    hud.labelText=@"Fetching Country";
    [view addSubview:hud];
    [hud show:animated];
    return MB_AUTORELEASE(hud);
}
+ (MB_INSTANCETYPE)showHUDAddedToDealer:(UIView *)view animated:(BOOL)animated {
    MBProgressHUD *hud = [[self alloc] initWithView:view];
    hud.removeFromSuperViewOnHide = YES;
    hud.labelText=@"Fetching Dealer";
    [view addSubview:hud];
    [hud show:animated];
    return MB_AUTORELEASE(hud);
}
